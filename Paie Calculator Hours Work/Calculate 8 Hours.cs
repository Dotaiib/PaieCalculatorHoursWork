...
{
    public partial class Calculate_8_Hours : Form
    {
        ...
        void Sortie_after_16h_for_less_8h()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (checkBox2.Checked)
                {
                    ...
                    TimeSpan TSM0100 = new TimeSpan(1, 00, 0);
                    TimeSpan TSM0130 = new TimeSpan(1, 30, 0);
                    TimeSpan TSM0200 = new TimeSpan(2, 00, 0);
                    TimeSpan TSM0230 = new TimeSpan(2, 30, 0);
                    TimeSpan TSM0300 = new TimeSpan(3, 00, 0);
                    TimeSpan TSM0330 = new TimeSpan(3, 30, 0);
                    TimeSpan TSM0400 = new TimeSpan(4, 00, 0);
                    TimeSpan TSM0430 = new TimeSpan(4, 30, 0);
                    TimeSpan TSM0500 = new TimeSpan(5, 00, 0);

                    TimeSpan TS1616 = new TimeSpan(16, 16, 00);
                    TimeSpan TS1645 = new TimeSpan(16, 45, 00);
                    TimeSpan TS1715 = new TimeSpan(17, 15, 00);

                    TimeSpan TS1716 = new TimeSpan(17, 16, 00);
                    TimeSpan TS1745 = new TimeSpan(17, 45, 00);
                    TimeSpan TS1815 = new TimeSpan(18, 15, 00);

                    TimeSpan TS1816 = new TimeSpan(18, 16, 00);
                    TimeSpan TS1845 = new TimeSpan(18, 45, 00);
                    TimeSpan TS1915 = new TimeSpan(19, 15, 00);

                    TimeSpan TS1916 = new TimeSpan(19, 16, 00);
                    TimeSpan TS1945 = new TimeSpan(19, 45, 00);
                    TimeSpan TS2015 = new TimeSpan(20, 15, 00);

                    TimeSpan TS2016 = new TimeSpan(20, 16, 00);
                    TimeSpan TS2045 = new TimeSpan(20, 45, 00);
                    TimeSpan TS2115 = new TimeSpan(21, 15, 00);

                    if (C08 >= TS1616 && C08 <= TS1645 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0030; }
                    if (C08 > TS1645 && C08 < TS1715 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0100; }

                    if (C08 >= TS1716 && C08 <= TS1745 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0130; }
                    if (C08 > TS1745 && C08 < TS1815 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0200; }

                    if (C08 >= TS1816 && C08 <= TS1845 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0230; }
                    if (C08 > TS1845 && C08 < TS1915 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0300; }

                    if (C08 >= TS1916 && C08 <= TS1945 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0330; }
                    if (C08 > TS1945 && C08 < TS2015 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0400; }

                    if (C08 >= TS2016 && C08 <= TS2045 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0430; }
                    if (C08 > TS2045 && C08 < TS2115 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0500; }
        ...
        void Sortie_after_14h_et_23h_for_less_8h()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (checkBox2.Checked)
                {
                    ...
                    TimeSpan TSM30 = new TimeSpan(0, 30, 0);
                    TimeSpan TSM100 = new TimeSpan(1, 0, 0);

                    TimeSpan TS1416 = new TimeSpan(14, 16, 00);
                    TimeSpan TS1445 = new TimeSpan(14, 45, 00);
                    TimeSpan TS1515 = new TimeSpan(15, 15, 00);

                    TimeSpan TS2316 = new TimeSpan(23, 16, 00);
                    TimeSpan TS2345 = new TimeSpan(23, 45, 00);
                    TimeSpan TS10015 = new TimeSpan(1, 0, 15, 00);

                    if (C08 >= TS1416 && C08 <= TS1445 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM30; }
                    if (C08 > TS1445 && C08 < TS1515 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM100; }

                    if (C08 >= TS2316 && C08 <= TS2345 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM30; }
                    if (C08 > TS2345 && C08 < TS10015 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM100; }
        ...
        void Sortie_Apres_16h()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (checkBox1.Checked)//this is working
                {
                    ...
                    if (C10 >= TS1616 && C10 <= TS1645) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0030; }
                    if (C10 > TS1645 && C10 < TS1715) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0100; }

                    if (C10 >= TS1716 && C10 <= TS1745) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0130; }
                    if (C10 > TS1745 && C10 < TS1815) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0200; }

                    if (C10 >= TS1816 && C10 <= TS1845) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0230; }
                    if (C10 > TS1845 && C10 < TS1915) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0300; }

                    if (C10 >= TS1916 && C10 <= TS1945) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0330; }
                    if (C10 > TS1945 && C10 < TS2015) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0400; }

                    if (C10 >= TS2016 && C10 <= TS2045) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0430; }
                    if (C10 > TS2045 && C10 < TS2115) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0500; }
        ...
        void Sortie_Apres_14h_et_23h()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (checkBox1.Checked)//this is working
                {
                    ...
                    if (C10 >= TS1416 && C10 <= TS1445) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM30; }
                    if (C10 > TS1445 && C10 < TS1515) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM100; }

                    if (C10 >= TS2316 && C10 <= TS2345) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM30; }
                    if (C10 > TS2345 && C10 < TS10015) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM100; }
                }
        ...
        void Change_Night_Hours_for_Calculation()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                TimeSpan T10h = new TimeSpan(10, 00, 00);
                TimeSpan T23h = new TimeSpan(23, 30, 00);
                ...
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th0) { dataGridView1.Rows[i].Cells[4].Value = TSC240; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th1) { dataGridView1.Rows[i].Cells[4].Value = TSC245; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th2) { dataGridView1.Rows[i].Cells[4].Value = TSC250; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th3) { dataGridView1.Rows[i].Cells[4].Value = TSC255; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th4) { dataGridView1.Rows[i].Cells[4].Value = TSC260; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th5) { dataGridView1.Rows[i].Cells[4].Value = TSC265; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th6) { dataGridView1.Rows[i].Cells[4].Value = TSC270; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th7) { dataGridView1.Rows[i].Cells[4].Value = TSC275; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th8) { dataGridView1.Rows[i].Cells[4].Value = TSC280; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th9) { dataGridView1.Rows[i].Cells[4].Value = TSC285; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th10) { dataGridView1.Rows[i].Cells[4].Value = TSC290; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th11) { dataGridView1.Rows[i].Cells[4].Value = TSC295; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th12) { dataGridView1.Rows[i].Cells[4].Value = TSC300; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th13) { dataGridView1.Rows[i].Cells[4].Value = TSC305; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th14) { dataGridView1.Rows[i].Cells[4].Value = TSC310; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th15) { dataGridView1.Rows[i].Cells[4].Value = TSC315; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th16) { dataGridView1.Rows[i].Cells[4].Value = TSC320; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th17) { dataGridView1.Rows[i].Cells[4].Value = TSC325; }
                if ((C2 >= T10h && C2 <= T23h) && C3 == Th18) { dataGridView1.Rows[i].Cells[4].Value = TSC330; }
        ...
        void Calculating_8Hours()
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                /*if (C2 != null && C3 != null && C4 == null && C5 == null && C6 == null && C7 == null)
                {
                    ...
                    dataGridView1.Rows[i].Cells[9].Value = timeSpan;
                }
                else
                {
                    if(C2 == null && C3 == null && C4 != null && C5 != null && C6 == null && C7 == null)
                    {
                        timeSpan = +C5.Subtract(C4);
                        dataGridView1.Rows[i].Cells[9].Value = timeSpan;
                    }
                    else
                    {
                        if (C2 != null && C3 != null && C4 != null && C5 != null && C6 == null && C7 == null)
                        {
                            timeSpan = (+C5.Subtract(C4)) + (+C3.Subtract(C2));
                            dataGridView1.Rows[i].Cells[9].Value = timeSpan;
                        }
                        else
                        {
                            if (C2 != null && C3 != null && C4 != null && C5 != null && C6 != null && C7 != null)
                            {
                                timeSpan = (+C7.Subtract(C6)) + (+C5.Subtract(C4)) + (+C3.Subtract(C2));
                                dataGridView1.Rows[i].Cells[9].Value = timeSpan;
                            }
                        }
                    }                    
        ...
        {
            //Sortie_Apres_14h_et_23h();
            Sortie_Apres_16h();
        }

        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            //It is for people who has 8h or less and there exit check after 14h or 23h

            //Sortie_after_14h_et_23h_for_less_8h();
            Sortie_after_16h_for_less_8h();
        }
    }
}
