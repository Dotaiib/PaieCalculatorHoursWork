...
{
    public partial class Import_Salaries : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("insert into QZ_Convert_Hours (Id_Table,matricule,name,Total_hours) values(@Id_Table,@matricule,@name,@Total_hours) ", sc);
