...
{
    public partial class WK_Hours_Blue : Form
    {
        ...
        {
            cn.Open();
            string Sql = "select distinct Matricule from WK_Hours where Id_Table = '" + comboBox1.Text + "' and H_Blue <> 0 ";
            SqlCommand cmd = new SqlCommand(Sql, cn);
            SqlDataReader DR = cmd.ExecuteReader();
            while (DR.Read())
        ...
        private void AfficherH_Blue()
        {
            cn.Open();
            string Sql = "select distinct H_Blue from WK_Hours where Id_Table = '" + comboBox1.Text + "' and matricule = '" + comboBox3.Text + "' ";
            SqlCommand cmd = new SqlCommand(Sql, cn);
            SqlDataReader DR = cmd.ExecuteReader();
            while (DR.Read())
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter(" select distinct matricule, name, H_Blue from WK_Hours where Id_Table = '" + comboBox1.Text + "' and Matricule = '" + comboBox3.Text + "' ", cn);
            cn.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count - 0; i++)
            {
                ...
                cmd.Parameters.AddWithValue("@Id_Table", comboBox1.Text + "_WKBlue");
