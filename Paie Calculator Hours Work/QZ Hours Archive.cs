...
{
    public partial class QZ_Hours_Archive : Form
    {
        ...
        {
            cn.Open();
            string Sql = "select distinct Matricule from QZ_Calcul where Id_Table = '" + comboBox1.Text + "' and H_Blue <> '0' ";
            SqlCommand cmd = new SqlCommand(Sql, cn);
            SqlDataReader DR = cmd.ExecuteReader();
            while (DR.Read())
        ...
        {
            cn.Open();
            string Sql = "select distinct H_Blue from QZ_Calcul where Id_Table = '" + comboBox1.Text + "' and matricule = '" + comboBox3.Text + "' ";
            SqlCommand cmd = new SqlCommand(Sql, cn);
            SqlDataReader DR = cmd.ExecuteReader();
            while (DR.Read())
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter(" select distinct matricule, name, H_Blue from QZ_Calcul where Id_Table = '" + comboBox1.Text + "' and Matricule = '" + comboBox3.Text + "' ", cn);
            cn.Open();
...

            {
                if ((dateTimePicker1.Value.Day == NbrDays01 || dateTimePicker1.Value.Day == NbrDays16) && (dateTimePicker2.Value.Day == NbrDays15 || dateTimePicker2.Value.Day == NbrDays30 || dateTimePicker2.Value.Day == NbrDays31))
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        {
                            MessageBox.Show("Blue Hours "+textBox1.Text+" are higher than "+textBox2.Text+", Check with the Dev" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        "Note that for " +comboBox3.Text+" no Blue Hours will be created",
                                        "Error Blue Hours",
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < dataGridView1.Rows.Count - 0; i++)
            {
                ...
                cmd.Parameters.AddWithValue("@Id_Table", comboBox1.Text +"_QZ_Blue");
                ...
                cmd.Parameters.AddWithValue("@Company", "Blue");
