...
{
    public partial class Calculate_4_Hours : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cn.Close();
            Minutes_Check();
            Change_Night_Hours_for_Calculation(); /*Calculating exits from 00 to 09 hour*/
            Calculating_4Hours();
            Less_time();
        ...
        void Less_time()
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                TimeSpan Ts14 = new TimeSpan(00, 14, 00);
                ...
                if (+C3.Subtract(C2) <= Ts04) { dataGridView1.Rows[i].Cells[11].Value = Ts9; }
                //                if (C10<= (C4+ Ts14)) { dataGridView1.Rows[i].Cells[11].Value = Ts9; }
        ...
        void Change_Night_Hours_for_Calculation()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                TimeSpan Th15 = new TimeSpan(07, 30, 00);
                TimeSpan Th16 = new TimeSpan(08, 00, 00);
                TimeSpan Th17 = new TimeSpan(08, 30, 00);
                TimeSpan Th18 = new TimeSpan(09, 00, 00);
                ...
                TimeSpan TSC315 = new TimeSpan(31, 30, 0);
                TimeSpan TSC320 = new TimeSpan(32, 00, 0);
                TimeSpan TSC325 = new TimeSpan(32, 30, 0);
                TimeSpan TSC330 = new TimeSpan(33, 00, 0);
                ...
                TimeSpan TSC89 = new TimeSpan(32, Convert.ToInt32(C8.Minutes), 0);
                TimeSpan TSC90 = new TimeSpan(33, Convert.ToInt32(C8.Minutes), 0);
                ...
                if (C8 >= Th14 && C8 < Th16) { dataGridView1.Rows[i].Cells[9].Value = TSC88; }
                if (C8 >= Th16 && C8 < Th18) { dataGridView1.Rows[i].Cells[9].Value = TSC89; }
                ...
                /*Calculating exits from 00 to 09 hour*/
                ...
                if (C2 != Th0 && C3 == Th15) { dataGridView1.Rows[i].Cells[4].Value = TSC315; }
                if (C2 != Th0 && C3 == Th16) { dataGridView1.Rows[i].Cells[4].Value = TSC320; }
                if (C2 != Th0 && C3 == Th17) { dataGridView1.Rows[i].Cells[4].Value = TSC325; }
                if (C2 != Th0 && C3 == Th18) { dataGridView1.Rows[i].Cells[4].Value = TSC330; }
        ...
        void Calculating_4Hours()
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                TimeSpan MT35 = new TimeSpan(17, 30, 00);
                TimeSpan MT36 = new TimeSpan(18, 00, 00);
                TimeSpan MT37 = new TimeSpan(18, 30, 00);
                TimeSpan MT38 = new TimeSpan(19, 00, 00);
                TimeSpan MT39 = new TimeSpan(19, 30, 00);
                TimeSpan MT40 = new TimeSpan(20, 00, 00);
                TimeSpan MT41 = new TimeSpan(20, 30, 00);
                TimeSpan MT42 = new TimeSpan(21, 00, 00);
                TimeSpan MT43 = new TimeSpan(21, 30, 00);


                //The area time values
                TimeSpan T0 = new TimeSpan(04, 00, 00);
                //
                TimeSpan T1 = new TimeSpan(04, 30, 00);
                TimeSpan T2 = new TimeSpan(05, 00, 00);
                TimeSpan T3 = new TimeSpan(05, 30, 00);
                TimeSpan T4 = new TimeSpan(6, 00, 00);
                TimeSpan T5 = new TimeSpan(6, 30, 00);
                TimeSpan T6 = new TimeSpan(7, 00, 00);
                TimeSpan T7 = new TimeSpan(7, 30, 00);
                TimeSpan T8 = new TimeSpan(8, 00, 00);
                TimeSpan T9 = new TimeSpan(8, 30, 00);
                TimeSpan T10 = new TimeSpan(9, 00, 00);
                TimeSpan T11 = new TimeSpan(9, 30, 00);
                TimeSpan T12 = new TimeSpan(10, 00, 00);
                TimeSpan T13 = new TimeSpan(10, 30, 00);
                TimeSpan T14 = new TimeSpan(11, 00, 00);
                TimeSpan T15 = new TimeSpan(11, 30, 00);
                TimeSpan T16 = new TimeSpan(12, 00, 00);
                TimeSpan T17 = new TimeSpan(12, 30, 00);
                TimeSpan T18 = new TimeSpan(13, 00, 00);
                TimeSpan T19 = new TimeSpan(13, 30, 00);
                TimeSpan T20 = new TimeSpan(14, 00, 00);
                TimeSpan T21 = new TimeSpan(14, 30, 00);
                TimeSpan T22 = new TimeSpan(15, 00, 00);
                TimeSpan T23 = new TimeSpan(15, 30, 00);
                TimeSpan T24 = new TimeSpan(16, 00, 00);
                TimeSpan T25 = new TimeSpan(16, 30, 00);
                TimeSpan T26 = new TimeSpan(17, 00, 00);
                TimeSpan T27 = new TimeSpan(17, 30, 00);
                TimeSpan T28 = new TimeSpan(18, 00, 00);
                TimeSpan T29 = new TimeSpan(18, 30, 00);
                TimeSpan T30 = new TimeSpan(19, 00, 00);
                TimeSpan T31 = new TimeSpan(19, 30, 00);
                TimeSpan T32 = new TimeSpan(20, 00, 00);
                TimeSpan T33 = new TimeSpan(20, 30, 00);
                TimeSpan T34 = new TimeSpan(21, 00, 00);
                TimeSpan T35 = new TimeSpan(21, 30, 00);
                TimeSpan T36 = new TimeSpan(22, 00, 00);
                TimeSpan T37 = new TimeSpan(22, 30, 00);
                TimeSpan T38 = new TimeSpan(23, 00, 00);
                TimeSpan T39 = new TimeSpan(23, 30, 00);
                TimeSpan T40 = new TimeSpan(24, 00, 00);
                TimeSpan T41 = new TimeSpan(24, 30, 00);
                                                                                                                                        ...
                                                                                                                                        else
                                                                                                                                        {
                                                                                                                                            ...
                                                                                                                                            else
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                else
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T33)
                                                                                                                                                    {
                                                                                                                                                    ...
                                                                                                                                                    {
                                                                                                                                                        if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T34)
                                                                                                                                                        {
                                                                                                                                                        ...
                                                                                                                                                        {
                                                                                                                                                            if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T35)
                                                                                                                                                            {
                                                                                                                                                                if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT35; }
                                                                                                                                                                else
                                                                                                                                                                {
                                                                                                                                                                    if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT35; }
                                                                                                                                                                    else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT35; }
                                                                                                                                                                }
                                                                                                                                                            }
                                                                                                                                                            else
                                                                                                                                                            {
                                                                                                                                                                if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T36)
                                                                                                                                                                {
                                                                                                                                                                    if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT36; }
                                                                                                                                                                    else
                                                                                                                                                                    {
                                                                                                                                                                        if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT36; }
                                                                                                                                                                        else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT36; }
                                                                                                                                                                    }
                                                                                                                                                                }
                                                                                                                                                                else
                                                                                                                                                                {
                                                                                                                                                                    if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T37)
                                                                                                                                                                    {
                                                                                                                                                                        if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT37; }
                                                                                                                                                                        else
                                                                                                                                                                        {
                                                                                                                                                                            if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT37; }
                                                                                                                                                                            else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT37; }
                                                                                                                                                                        }
                                                                                                                                                                    }
                                                                                                                                                                    else
                                                                                                                                                                    {
                                                                                                                                                                        if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T38)
                                                                                                                                                                        {
                                                                                                                                                                            if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT38; }
                                                                                                                                                                            else
                                                                                                                                                                            {
                                                                                                                                                                                if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT38; }
                                                                                                                                                                                else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT38; }
                                                                                                                                                                            }
                                                                                                                                                                        }
                                                                                                                                                                        else
                                                                                                                                                                        {
                                                                                                                                                                            if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T39)
                                                                                                                                                                            {
                                                                                                                                                                                if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT39; }
                                                                                                                                                                                else
                                                                                                                                                                                {
                                                                                                                                                                                    if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT39; }
                                                                                                                                                                                    else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT39; }
                                                                                                                                                                                }
                                                                                                                                                                            }
                                                                                                                                                                            else
                                                                                                                                                                            {
                                                                                                                                                                                if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T40)
                                                                                                                                                                                {
                                                                                                                                                                                    if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT40; }
                                                                                                                                                                                    else
                                                                                                                                                                                    {
                                                                                                                                                                                        if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT40; }
                                                                                                                                                                                        else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT40; }
                                                                                                                                                                                    }
                                                                                                                                                                                }
                                                                                                                                                                                else
                                                                                                                                                                                {

                                                                                                                                                                                    if (TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString()) == T41)
                                                                                                                                                                                    {
                                                                                                                                                                                        if (C6 != Ts && C7 != Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT41; }
                                                                                                                                                                                        else
                                                                                                                                                                                        {
                                                                                                                                                                                            if (C4 != Ts && C5 != Ts && C6 == Ts && C7 == Ts) { dataGridView1.Rows[i].Cells[11].Value = C8 - MT41; }
                                                                                                                                                                                            else { dataGridView1.Rows[i].Cells[11].Value = C8 - MT41; }
                                                                                                                                                                                        }
                                                                                                                                                                                    }
                                                                                                                                                                                }
                                                                                                                                                                            }
        ...
        void Sortie_Apres_11h()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (checkBox1.Checked)//this is working
                {
                    ...
                    TimeSpan C10 = TimeSpan.Parse(dataGridView1.Rows[i].Cells[11].Value.ToString());
                    TimeSpan TSM0030 = new TimeSpan(0, 30, 0);
                    TimeSpan TSM0100 = new TimeSpan(1, 0, 0);
                    TimeSpan TSM0130 = new TimeSpan(1, 30, 0);
                    TimeSpan TSM0200 = new TimeSpan(2, 0, 0);

                    TimeSpan TS1116 = new TimeSpan(11, 16, 00);
                    TimeSpan TS1145 = new TimeSpan(11, 45, 00);
                    TimeSpan TS1215 = new TimeSpan(12, 15, 00);
                    TimeSpan TS1216 = new TimeSpan(12, 16, 00);
                    TimeSpan TS1245 = new TimeSpan(12, 45, 00);
                    TimeSpan TS1315 = new TimeSpan(13, 15, 00);


                    if (C10 >= TS1116 && C10 <= TS1145) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0030; }
                    if (C10 > TS1145 && C10 < TS1215) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0100; }
                    if (C10 >= TS1216 && C10 <= TS1245) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0130; }
                    if (C10 > TS1245 && C10 < TS1315) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0200; }
                }
        ...
        void Sortie_Apres_12h()
        {

            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {

                if (checkBox2.Checked)//this is working
                {
                    ...
                    if (C10 >= TS1216 && C10 <= TS1245) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0030; }
                    if (C10 > TS1245 && C10 < TS1315) { dataGridView1.Rows[i].Cells[11].Value = C10 - TSM0100; }
                }
        ...
        void Sortie_after_11h_for_less_4h()
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                {
                    TimeSpan C08 = TimeSpan.Parse(dataGridView1.Rows[i].Cells[9].Value.ToString());
                    TimeSpan C09 = TimeSpan.Parse(dataGridView1.Rows[i].Cells[10].Value.ToString());
                    TimeSpan C10 = TimeSpan.Parse(dataGridView1.Rows[i].Cells[11].Value.ToString());

                    TimeSpan TSH08 = new TimeSpan(8, 0, 0);
                    ...
                    if (C08 >= TS1116 && C08 <= TS1145 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0030; }
                    if (C08 > TS1145 && C08 < TS1215 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0100; }
                    if (C08 >= TS1216 && C08 <= TS1245 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0130; }
                    if (C08 > TS1245 && C08 < TS1315 && C09 <= TSH08) { dataGridView1.Rows[i].Cells[11].Value = C08 - TSM0200; }
